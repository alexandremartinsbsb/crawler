...
public class CrawlerCenaContemporanea {
  ...
  public List<Object> buscar() {
    ...
    try {
      doc = Jsoup.connect("http://www.cenacontemporanea.com.br/programacao-espetaculos-2017/")
          .timeout(300000).get();
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  private EventoCenaContemporanea getInformacoesEvento(String link) {
    ...
    String content2 =
        doc.select("aside.sidebar-programacao > div.box-servico > div.area-infos > div.servico")
            .first().html();
