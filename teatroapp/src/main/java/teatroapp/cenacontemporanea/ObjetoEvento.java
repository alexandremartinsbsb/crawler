...
public class ObjetoEvento {
	...
	private List<ObjetoServico> listaServicos = new ArrayList<>();
	...
	public List<ObjetoServico> getListaServicos() {
		return listaServicos;
	}

	public void setListaServicos(List<ObjetoServico> listaServicos) {
	...
	public String toString() {
		return "ObjetoEvento [nome=" + nome + ", urlImagem=" + urlImagem + ", descricao=" + descricao
				+ ", listaServicos=" + listaServicos + ", duracao=" + duracao + ", classificacao=" + classificacao
				+ "]";
	}
